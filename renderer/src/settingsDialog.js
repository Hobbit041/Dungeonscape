              ...
              <div class="settings-section">
                ...
                <div class="settings-row" id="remoteControlRow">
                  <button class="settings-btn" id="settingsRemoteStart"
                    style="${this.ui._webServerRunning ? 'display:none' : ''}">
                    <i class="fas fa-wifi"></i> ${t('settings.remoteControlStart')}
                  </button>
                  <div id="remoteActiveRow" style="display:${this.ui._webServerRunning ? 'flex' : 'none'}; align-items:center; gap:8px; flex-wrap:wrap">
                    <code id="remoteControlUrl" class="settings-remote-url"
                      title="${t('settings.remoteControlCopy')}">${this.ui._webServerUrl}</code>
